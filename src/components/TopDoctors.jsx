...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <button onClick={()=>{navigate('/doctors'); }} className='bg-blue-600 text-white px-12 py-3 rounded-full mt-5 hover:translate-y-[-10px] transition-all duration-500'>More</button>
    </div>
  )
}
